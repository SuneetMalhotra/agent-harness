...
// gemini.ts / stub.ts, so the harness operating layer is backend-agnostic.
//
...
// on focal-method-to-test-case tasks; this provider lets the multi-agent
// SDLC pipeline run against any model Ollama can serve, including those
// weights and any locally fine-tuned variant.
