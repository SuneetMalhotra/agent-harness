...
// actual HTTPS call requires the operator to supply OPENAI_API_KEY and a
// minimal HTTP client. The stub throws a clear error pointing at the missing
// configuration. The article's §7.3 reproducibility paragraph documents the
// exact command surface this stub exposes.
