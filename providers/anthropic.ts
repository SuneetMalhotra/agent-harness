...
export interface AnthropicProviderOptions {
  ...
  model?: string;
  /**
   * Subprocess timeout, milliseconds. Default 300_000 (5 min). Agent steps
   * (PRD generation, test-case generation, automation code) can each take
   * 30–120s; the default is conservative.
   */
  timeoutMs?: number;
}
