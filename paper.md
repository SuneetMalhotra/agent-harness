...
**Table 3.** LLM DOM-healing generalizes across two applications and two model families (correct-element recovery; per-application identity-oracle denominators).
